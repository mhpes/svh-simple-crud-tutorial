...
- Example-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- Example-ui: main application module, development time
- Example-production: module that produces a production mode WAR for deployment
